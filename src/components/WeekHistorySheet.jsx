...
function InsightCard({ insight, loading, error }) {
  if (loading) {
    return <p className="px-4 pt-3 pb-4 text-body-1 text-gray-400 border-b border-gray-100">Generating your recap…</p>
  }
  if (error) {
    return <p className="px-4 pt-3 pb-4 text-body-1 text-gray-400 border-b border-gray-100">Couldn't load an insight for this week.</p>
  }
  ...
  return (
    <div className="px-4 pt-3 pb-4 border-b border-gray-100">
      ...
      <p className="text-caption italic text-gray-400 mt-2">Generated by Claude AI</p>
    </div>
  )
}
